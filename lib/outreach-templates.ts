  ...
  switch (template) {
    case 'it_vendor':
      return {
        ...
        body: `${greet}\n\nI run PracticeGuard Compliance Group — we help dental and medical practices prepare for proposed HIPAA Security Rule updates (MFA, encryption, risk assessments, the works).\n\nSince ${name} is already managing the technical side for your clients, you're probably seeing firsthand how far most of them are from strong security requirements. I'd like to offer a referral arrangement: you send a practice our way, we pay you a referral fee for every one that becomes a paying client. No cost or obligation on your end beyond the introduction.\n\nWorth a quick call this week?\n\nDallas Mitchell\nPracticeGuard Compliance Group\n(615) 785-3493\n${partnersLink}`,
      }
    case 'billing':
      return {
        subject: 'Partnership idea — your clients & HIPAA compliance',
        body: `${greet}\n\n${name}'s clients trust you with their revenue cycle — which means you're often the first to hear when something's wrong on the compliance side too (a breach, an audit notice, an insurance renewal issue).\n\nI run PracticeGuard Compliance Group, helping dental and medical practices meet HIPAA security requirements and proposed Security Rule updates. I'd like to set up a referral partnership — a fee for every practice you send our way that becomes a client.\n\nHappy to send more details or hop on a quick call.\n\nDallas Mitchell\nPracticeGuard Compliance Group\n(615) 785-3493\n${partnersLink}`,
      }
    case 'cpa':
      return {
        subject: 'A referral opportunity for your healthcare clients',
        body: `${greet}\n\nIf ${name} works with dental or medical practices, you've probably heard clients mention HIPAA compliance or cyber insurance renewals coming up — usually as a headache, not something they've fully handled.\n\nI run PracticeGuard Compliance Group and help practices in Middle Tennessee get compliant with HIPAA security requirements and proposed updates. I'd like to offer a simple referral arrangement — a fee for every practice you introduce that becomes a client, no work required on your end beyond the intro.\n\nWould you be open to a short call?\n\nDallas Mitchell\nPracticeGuard Compliance Group\n(615) 785-3493\n${partnersLink}`,
      }
    ...
    case 'consultant':
      return {
        ...
        body: `${greet}\n\nThe dental and medical practices ${name} works with are facing proposed HIPAA Security Rule updates — the biggest potential change to HIPAA security standards since 2003. Most aren't aware how exposed they are until an audit notice or insurance renewal forces the issue.\n\nI run PracticeGuard Compliance Group and help practices get compliant — audits, ongoing monitoring, and cyber insurance readiness. I'd like to set up a referral partnership: a fee for every practice you introduce that becomes a client, no work required on your end beyond the intro.\n\nWorth a quick call?\n\nDallas Mitchell\nPracticeGuard Compliance Group\n(615) 785-3493\n${partnersLink}`,
      }
    case 'lead':
    default:
      return {
        subject: `Quick question about ${name}'s HIPAA compliance`,
        body: `${greet}\n\nI work with dental and medical practices${city ? ` in ${city}` : ' across Middle Tennessee'} to help them prepare for proposed HIPAA Security Rule updates — the biggest potential change to HIPAA security standards since 2003.\n\nMost practices we talk to aren't aware how far they are from strong security controls (multi-factor authentication, encryption, vulnerability scanning, and more) until it's too late.\n\nWould you be open to a free 30-minute readiness check? No pressure — just a clear picture of where ${name} stands.\n\nBest,\nDallas Mitchell\nPracticeGuard Compliance Group\n(615) 785-3493\n${homeLink}`,
      }
  }
}
