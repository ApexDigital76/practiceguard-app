...
const MONTHLY_SERVICES = [
  ...
  },
  {
    ...
    items: [
      ...
      'Annual penetration test coordination (required under 2026 HIPAA Security Rule)',
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/leads', {
        ...
        body: JSON.stringify({ ...form, concern: 'Managed Compliance (From $675/mo)', source: 'managed-compliance-page' }),
      })
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-[#0b2340] text-center mb-10">Everything Included Every Month</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-[#0b2340] text-center mb-3">What We Do Every Month</h2>
          <p className="text-gray-500 text-center mb-12">A breakdown of every service included in your Managed Compliance program.</p>
      ...
      <section id="get-started" className="py-20 px-6 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-10">Fill out the form and Dallas will reach out to discuss your practice's specific needs and confirm pricing.</p>
          {status === 'success' ? (
