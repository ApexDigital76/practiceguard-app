...
const WHO_FOR = [
  'Have never had a formal HIPAA risk analysis',
  'Are preparing for proposed Security Rule updates',
  'Need documentation for cyber insurance',
  'Want a prioritized fix list instead of generic advice',
]

const PROCESS = [
  { step: '1', title: 'Request & confirm', desc: 'Tell us about your practice. We confirm scope and schedule before any charge.' },
  { step: '2', title: 'Collect & review', desc: 'We gather the information and access needed to assess your environment.' },
  { step: '3', title: 'Assess all four areas', desc: 'Technical, administrative, physical, and formal risk analysis.' },
  { step: '4', title: 'Deliver your package', desc: 'Written reports plus a live 60-minute walkthrough with Dallas.' },
  { step: '5', title: 'Leave with a plan', desc: 'You know what matters most and what to do next.' },
]
    ...
    try {
      const res = await fetch('/api/leads', {
        ...
        body: JSON.stringify({
          ...
          phone: form.phone,
          email: form.email,
          concern: 'Compliance Audit ($1,997)',
          source: 'compliance-audit-page',
        }),
      })
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              <p className="text-white/70 text-lg max-w-2xl">
                A full assessment of your practice's HIPAA Security Rule posture — technical, administrative, and
                physical — with a clear roadmap of what to fix first.
              </p>
            </div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-8 max-w-2xl mx-auto">
            Dental and medical practices that need a real picture of their compliance risk — before an OCR inquiry, a
            cyber insurance renewal, or a painful surprise.
          </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-[#0b2340] text-center mb-3">How the audit works</h2>
          <p className="text-gray-500 text-center mb-12">Five clear steps from request to remediation plan.</p>
          <div className="grid md:grid-cols-5 gap-4">
            {PROCESS.map(({ step, title, desc }) => (
              <div key={step} className="bg-gray-50 rounded-xl border border-gray-100 p-5 text-center md:text-left">
                <div className="w-8 h-8 bg-[#14b8a6] text-[#0b2340] font-bold rounded-full flex items-center justify-center mx-auto md:mx-0 mb-3 text-sm">
                  {step}
                </div>
                <div className="font-semibold text-[#0b2340] mb-1 text-sm">{title}</div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-12">Every area of the HIPAA Security Rule — nothing is skipped.</p>
            ...
            {FAQS.map(({ q, a }, i) => (
              <div key={q} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                >
                  ...
                  <ArrowRight
                    size={16}
                    className={`flex-shrink-0 transition-transform text-[#14b8a6] ${openFaq === i ? 'rotate-90' : ''}`}
                  />
                </button>
                {openFaq === i && (
      ...
      <section id="get-started" className="py-20 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-10">
            Fill out the form below and Dallas will reach out within 1 business day. No payment until details are
            confirmed.
          </p>
          {status === 'success' ? (
