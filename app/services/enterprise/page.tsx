      ...
      <section className="bg-[#0b2340] text-white py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-[#c9a84c]/20 text-[#c9a84c] px-3 py-1 rounded-full text-sm font-medium mb-6">
            <Star size={14} className="fill-[#c9a84c]" /> Enterprise Program
          </div>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
                Enterprise Compliance Program<br />
                <span className="text-[#c9a84c]">The Complete Solution.</span>
              </h1>
            ...
            <div className="flex-shrink-0 bg-white/10 border border-white/20 rounded-2xl px-8 py-6 text-center">
              ...
              <div className="text-4xl font-bold text-[#c9a84c]">$1,200<span className="text-2xl">/mo</span></div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            {ENTERPRISE_SERVICES.map(({ icon: Icon, title, items, highlight }) => (
              <div key={title} className={`rounded-2xl p-8 border ${highlight ? 'bg-[#0b2340] border-[#c9a84c]/30' : 'bg-gray-50 border-gray-100'}`}>
                <div className="flex items-center gap-3 mb-5">
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${highlight ? 'bg-[#c9a84c]' : 'bg-[#0b2340]'}`}>
                    <Icon className={highlight ? 'text-[#0b2340]' : 'text-[#c9a84c]'} size={18} />
                  </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden">
            <div className="grid grid-cols-4 bg-white/10 px-6 py-4 text-sm font-bold text-white">
              ...
              <div className="text-center text-[#c9a84c]">Enterprise</div>
            </div>
            {COMPARE.map(({ feature, audit, managed, enterprise }, i) => (
              <div key={feature} className={`grid grid-cols-4 px-6 py-3 text-sm border-t border-white/5 ${i % 2 === 0 ? '' : 'bg-white/5'}`}>
                ...
                <div className="text-center">{enterprise ? <CheckCircle className="text-[#c9a84c] mx-auto" size={16} /> : <span className="text-white/20">—</span>}</div>
              </div>
            ))}
            <div className="grid grid-cols-4 px-6 py-4 border-t border-white/10 bg-white/5">
              ...
              <div className="text-center text-[#c9a84c] font-bold text-sm">$1,200/mo</div>
            </div>
          </div>
        </div>
      </section>
